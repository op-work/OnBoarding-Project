...
def render_onboarding_day_page(db: Session):
    ...
    # Onboarding Day Stage Progress Bar (Percentage on the Left)
    ...
    if st.button("Back to Associate Workspace", key="btn_back_onb_day", type="primary", use_container_width=True):
